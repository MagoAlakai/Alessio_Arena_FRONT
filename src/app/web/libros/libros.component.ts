...
export class LibrosComponent implements OnInit {
  ...
  constructor() {
    ...
    this.libros = [
      {
        titulo: 'Ninna Nanna Delle Mosche (Fandango Libri, 2021)',
        descripcion: 'En los años 20, el norte de Chile es la tierra prometida para una comunidad de emigrantes italianos. Son mineros que han colonizado los pueblos de una interminable pampa, trabajando en las refinerías de extracción de salitre. Su trabajo los encierra bajo tierra y a menudo los mata. Tienen pocas actividades de ocio, algo de alcohol y mucha nostalgia. Gregorio Zafarone es el trabajador de la oficina Porvenir que escribe cartas para que sus compañeros analfabetos las envíen a sus familias en Italia. Pero las suyas, las cartas dirigidas a Berto Macaluso, un joven panadero de Palmira, el pueblo del interior de Lucania del que ambos proceden, nunca han recibido respuesta. Gregorio, quemado por el sol y la falta, no deja de preguntarse qué pudo haberle pasado. Hasta el día en que todo cambia. Las palabras para su amor prohibido llegan a Berto, encerradas en un sobre con una mosca atrapada. Berto parte hacia Chile y deja atrás todo lo que conoce. Tras los pasos del panadero estará su esposa, Serafina Canaria, una nana cuya voz concilia el sueño y el amor. Ninna nanna delle mosche es una historia confiada a personajes en tránsito entre mundos lejanos: mujeres que cruzan los Andes a lomos de una mula, peregrinos danzantes del desierto de Atacama y un circo de desposeídos se unirán en un viaje que parece no tener fin, en una aventura de deseos inconfesables. Una novela de amor y revolución que llevará a los lectores al borde del mundo, al fuego vivo de las pasiones.',
        imagen: '/assets/images/mosche.png',
      },
      {
